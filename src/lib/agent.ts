...
- When confirming additions, ALWAYS include the ticket number from the tool result (e.g. "#42 added"). A confirmation without a number is likely a hallucination.
