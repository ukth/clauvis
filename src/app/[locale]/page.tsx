...
const dict = {
  en: {
    ...
    demoLeft1: "[mosun-monorepo] Fix image upload bug\nAdded!",
    demoRight2: "show my todos",
    demoLeft2: "[mosun-monorepo]\n1. Fix image upload bug\n2. Mobile blocked user list\n\n[team-maker]\n1. Session loading error\n2. Deploy button UI",
    demoRight3: "mosun 1 done",
    demoLeft3: "Done: Fix image upload bug (3 remaining)",
    terminalStart: "Session started",
    terminalTodos: "2 todos:",
    terminalTodo1: "1. Mobile blocked user list",
    terminalTodo2: "2. Improve onboarding flow",
    terminalYou1: "let's work on #1",
    terminalWorking: "Working on Mobile blocked user list...",
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="animate-fade-up-delay-2 mt-10 flex flex-wrap gap-4 items-center">
            ...
            <code className="text-xs sm:text-sm font-mono text-muted bg-surface px-3 py-2 rounded border border-border select-all cursor-pointer hover:border-accent/40 transition-colors break-all flex items-center gap-2">
              <span>curl -sL raw.githubusercontent.com/ukth/clauvis/main/scripts/setup.sh | bash</span>
              <CopyButton text="curl -sL https://raw.githubusercontent.com/ukth/clauvis/main/scripts/setup.sh | bash" />
            </code>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <Step n="2" title={t.step2Title}>
              <div className="bg-surface rounded border border-border p-4 font-mono text-xs sm:text-sm group overflow-x-auto flex items-center gap-2">
